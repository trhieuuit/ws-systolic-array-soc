...
REM
REM Generated by Vivado on Mon Apr 13 19:17:15 +0700 2026
...
echo "xvlog --incr --relax -prj tb_systolic_array_vlog.prj"
call xvlog  --incr --relax -prj tb_systolic_array_vlog.prj -log xvlog.log
