...
# Currently, the core math engine and its immediate controller are fully functional in simulation. The surrounding system-on-chip (SoC) infrastructure (DMA, high-level tiling, and FPGA deployment) is actively under development.
...
# !\[Weight Stationary Architecture Block Diagram](docs/images/architecture\_diagram.png) \*(Note: Replace with your actual image path)\*
...
# 4\.  \*\*Hardware Deployment:\*\* Moving from simulation (Vivado) to implement on an FPGA development board (Xilinx KV260).
