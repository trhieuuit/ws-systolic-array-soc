...
#
# Script generated by Vivado on Mon May 25 11:28:01 +0700 2026
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L xil_defaultlib -L axi_infrastructure_v1_1_0 -L axi_vip_v1_1_21 -L zynq_ultra_ps_e_vip_v1_0_21 -L axi_datamover_v5_1_37 -L axi_sg_v4_1_21 -L axi_dma_v7_1_36 -L xlconstant_v1_1_10 -L proc_sys_reset_v5_0_17 -L smartconnect_v1_0 -L axi_register_slice_v2_1_35 -L xlconcat_v2_1_7 -L uvm -L xilinx_vip -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot design_1 xil_defaultlib.design_1 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim design_1 -key {Behavioral:sim_1:Functional:design_1} -tclbatch cmd.tcl -protoinst "protoinst_files/bd_afc3.protoinst" -protoinst "protoinst_files/bd_48ac.protoinst" -protoinst "protoinst_files/bd_886d.protoinst" -protoinst "protoinst_files/bd_892d.protoinst" -protoinst "protoinst_files/design_1.protoinst" -log simulate.log
}
...
map_local_libs()
{
  ...
  local_libs=(xil_defaultlib xlconcat_v2_1_7)
