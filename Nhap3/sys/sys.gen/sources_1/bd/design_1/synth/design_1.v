...
module design_1
  ...
  wire [39:0]axi_dma_0_M_AXI_MM2S_ARADDR;
  ...
  wire [39:0]axi_dma_1_M_AXI_MM2S_ARADDR;
  ...
  wire [511:0]axi_dma_1_M_AXI_S2MM_WDATA;
  wire axi_dma_1_M_AXI_S2MM_WLAST;
  wire axi_dma_1_M_AXI_S2MM_WREADY;
  wire [63:0]axi_dma_1_M_AXI_S2MM_WSTRB;
  ...
  wire [511:0]myip_0_M00_AXIS_TDATA;
  ...
  design_1_myip_0_0 myip_0
       (.m00_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .s00_axis_tstrb({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
        .s00_axis_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID),
        .s01_axis_aclk(zynq_ultra_ps_e_0_pl_clk0),
        .s01_axis_aresetn(rst_ps8_0_99M_peripheral_aresetn),
        ...
        .s01_axis_tstrb({1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1,1'b1}),
  ...
  design_1_smartconnect_0_1 smartconnect_1
       (.M00_AXI_araddr(smartconnect_1_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(rst_ps8_0_99M_peripheral_aresetn));
  design_1_smartconnect_0_2 smartconnect_2
       (.M00_AXI_awaddr(smartconnect_2_M00_AXI_AWADDR),
        ...
        .S00_AXI_awaddr(axi_dma_1_M_AXI_S2MM_AWADDR),
        .S00_AXI_awburst(axi_dma_1_M_AXI_S2MM_AWBURST),
        .S00_AXI_awcache(axi_dma_1_M_AXI_S2MM_AWCACHE),
        .S00_AXI_awlen(axi_dma_1_M_AXI_S2MM_AWLEN),
        .S00_AXI_awlock(1'b0),
        .S00_AXI_awprot(axi_dma_1_M_AXI_S2MM_AWPROT),
        .S00_AXI_awqos({1'b0,1'b0,1'b0,1'b0}),
        .S00_AXI_awready(axi_dma_1_M_AXI_S2MM_AWREADY),
        .S00_AXI_awsize(axi_dma_1_M_AXI_S2MM_AWSIZE),
        .S00_AXI_awvalid(axi_dma_1_M_AXI_S2MM_AWVALID),
        .S00_AXI_bready(axi_dma_1_M_AXI_S2MM_BREADY),
        .S00_AXI_bresp(axi_dma_1_M_AXI_S2MM_BRESP),
        .S00_AXI_bvalid(axi_dma_1_M_AXI_S2MM_BVALID),
        .S00_AXI_wdata(axi_dma_1_M_AXI_S2MM_WDATA),
        .S00_AXI_wlast(axi_dma_1_M_AXI_S2MM_WLAST),
        .S00_AXI_wready(axi_dma_1_M_AXI_S2MM_WREADY),
        .S00_AXI_wstrb(axi_dma_1_M_AXI_S2MM_WSTRB),
  ...
  design_1_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
       (.maxigp0_araddr(zynq_ultra_ps_e_0_M_AXI_HPM0_FPD_ARADDR),
        ...
        .saxigp2_awaddr(smartconnect_2_M00_AXI_AWADDR),
        .saxigp2_awburst(smartconnect_2_M00_AXI_AWBURST),
        .saxigp2_awcache(smartconnect_2_M00_AXI_AWCACHE),
        .saxigp2_awid({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0}),
        .saxigp2_awlen(smartconnect_2_M00_AXI_AWLEN),
        .saxigp2_awlock(smartconnect_2_M00_AXI_AWLOCK),
        .saxigp2_awprot(smartconnect_2_M00_AXI_AWPROT),
        .saxigp2_awqos(smartconnect_2_M00_AXI_AWQOS),
        .saxigp2_awready(smartconnect_2_M00_AXI_AWREADY),
        .saxigp2_awsize(smartconnect_2_M00_AXI_AWSIZE),
        .saxigp2_awuser(1'b0),
        .saxigp2_awvalid(smartconnect_2_M00_AXI_AWVALID),
        .saxigp2_bready(smartconnect_2_M00_AXI_BREADY),
        .saxigp2_bresp(smartconnect_2_M00_AXI_BRESP),
        .saxigp2_bvalid(smartconnect_2_M00_AXI_BVALID),
        .saxigp2_rready(1'b0),
        .saxigp2_wdata(smartconnect_2_M00_AXI_WDATA),
        .saxigp2_wlast(smartconnect_2_M00_AXI_WLAST),
        .saxigp2_wready(smartconnect_2_M00_AXI_WREADY),
        .saxigp2_wstrb(smartconnect_2_M00_AXI_WSTRB),
        .saxigp2_wvalid(smartconnect_2_M00_AXI_WVALID),
